<template>
  <div class="w-full flex-grow flex flex-col bg-bg-cream/20">
    ...
    <div class="max-w-6xl w-full mx-auto px-4 py-8 flex-grow flex flex-col">
      <!-- ==============================================
           AUTHENTICATED STATE (User is logged in)
           ============================================== -->
      <div v-if="authStore.isAuthenticated" class="shopping-list flex-grow flex flex-col">
        ...
        <!-- Platzhalter für die spätere Liste -->
        <div
      ...
      >
        ...
        <div class="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          ...
          <RouterLink
            to="/login"
            class="flex-1 flex justify-center items-center text-center bg-white text-dark-green font-bold px-8 py-3.5 rounded-xl border border-gray-200 hover:border-primary-green hover:text-primary-green transition-colors shadow-sm"
          >
